...
import { getPackages, installPackageOperation } from "@/lib/api/packages";
    ...
    <div className="space-y-6 p-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Download and install a FHIR package from the registry using the $install-package operation
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleInstall} className="space-y-4">
            ...
            <div className="flex items-center gap-4">
              ...
              {operationResult && (
                <div className={`text-sm ${operationResult.startsWith("Error") ? "text-destructive" : "text-success"}`}>
                  {operationResult}
                </div>
              )}
            </div>
