...
<span aria-hidden="true">🔗</span> **Spec**: [FHIR RESTful API](https://hl7.org/fhir/R4/http.html)
...
<span aria-hidden="true">🔗</span> **Spec**: [create](https://hl7.org/fhir/R4/http.html#create),
...
<span aria-hidden="true">🔗</span> **Spec**: [read](https://hl7.org/fhir/R4/http.html#read),
...
<span aria-hidden="true">🔗</span> **Spec**: [update](https://hl7.org/fhir/R4/http.html#update),
...
<span aria-hidden="true">🔗</span> **Spec**: [patch](https://hl7.org/fhir/R4/http.html#patch),
...
<span aria-hidden="true">🔗</span> **Spec**: [delete](https://hl7.org/fhir/R4/http.html#delete),
...
<span aria-hidden="true">🔗</span> **Spec (Batch/Transaction)**: [batch/transaction](https://hl7.org/fhir/R4/http.html#transaction)
...
<span aria-hidden="true">🔗</span> **Spec**: [HTTP Status Codes](https://hl7.org/fhir/R4/http.html#Status-Codes),
...
<span aria-hidden="true">🔗</span> **Spec (Capability Declaration)**: [CapabilityStatement](https://hl7.org/fhir/R4/capabilitystatement.html)
...
<span aria-hidden="true">🔗</span> **Spec (Capabilities)**: [capabilities (`GET [base]/metadata`)](https://hl7.org/fhir/R4/http.html#capabilities)

Use the interactive API playground to test CRUD operations:

<CardGroup cols={2}>
  <Card title="Create" icon="plus" href="/api-reference/endpoint/create">
    Try creating resources
  </Card>
  <Card title="Read" icon="eye" href="/api-reference/endpoint/read">
    Test read operations
  </Card>
  <Card title="Update" icon="pen" href="/api-reference/endpoint/update">
    Practice updates
  </Card>
...
<span aria-hidden="true">🔗</span> **Spec**: [search](https://hl7.org/fhir/R4/http.html#search),
[batch/transaction](https://hl7.org/fhir/R4/http.html#transaction), [history](https://hl7.org/fhir/R4/http.html#history)

<CardGroup cols={2}>
  <Card title="Search Operations" icon="magnifying-glass" href="/server/search">
  ...
  <Card
    ...
    href="/server/versioning-history"
  >
