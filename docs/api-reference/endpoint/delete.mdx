...
<CardGroup cols={2}>
  <Card title="Resource History" icon="clock-rotate-left" href="/api-reference/history/resource">
  ...
  <Card title="Update Resource" icon="pen" href="/api-reference/endpoint/update">
    Modify instead of deleting
  </Card>
  <Card title="Learn FHIR CRUD" icon="book" href="/learn-fhir/crud">
