...
<CardGroup cols={2}>
  <Card title="Versioned Read" icon="clock-rotate-left" href="/api-reference/history/versioned-read">
    Read a specific historical version
  </Card>
  <Card title="Search" icon="magnifying-glass" href="/api-reference/search/type">
    Find resources by criteria
  </Card>
  <Card title="Update" icon="pen" href="/api-reference/endpoint/update">
    Modify a resource
  </Card>
  <Card title="Resource History" icon="timeline" href="/api-reference/history/resource">
