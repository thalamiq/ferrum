...
<CardGroup cols={2}>
  ...
  <Card title="Read Resource" icon="eye" href="/api-reference/endpoint/read">
    Get current version before patching
  </Card>
  <Card title="JSON Patch RFC" icon="book" href="https://tools.ietf.org/html/rfc6902">
    Official JSON Patch specification
  </Card>
  <Card title="Learn FHIR CRUD" icon="graduation-cap" href="/learn-fhir/crud">
